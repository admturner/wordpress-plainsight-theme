<?php
/**
 * Template Name: Standard-width, no sidebar
 * 
 * A custom page template, standard width, centered, with no sidebar.
 *
 * @package WordPress
...
get_header(); ?>
	...
	<div id="content" class="one-column-standard" role="main">
